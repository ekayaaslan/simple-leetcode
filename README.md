...
Two pointers. A technique using two indices to traverse a data structure, typically moving towards each other or in parallel.
...
Connected components, Unrooted tree.
